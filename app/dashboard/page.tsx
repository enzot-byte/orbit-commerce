...
const continueCourses = [
  {
    ...
    progress: 68,
    lastLesson: "Aula 14: Estratégia de Precificação",
  ...
  },
  {
    ...
    progress: 32,
    lastLesson: "Aula 7: Campanhas no Google Shopping",
...
const recentTools = [
  {
    ...
    desc: "Calcule sua margem de lucro real",
    icon: TrendingUp,
    color: "text-emerald-400",
    bg: "bg-emerald-900/20",
  },
  {
    ...
    desc: "Títulos otimizados para marketplaces",
    icon: Zap,
    color: "text-accent-400",
    bg: "bg-accent-800/20",
  },
  {
    ...
    desc: "Compare fretes e economize",
    icon: Clock,
    color: "text-orbit-400",
    bg: "bg-orbit-900/30",
  },
...
const upcomingLives = [
  ...
  },
  {
    date: "22 Abr",
    time: "20h",
    topic: "Amazon FBA — vale a pena em 2025?",
    host: "Bruno Costa",
  },
];
...
const updates = [
  {
    date: "05 Abr",
    title: "Nova ferramenta: Monitor de Preços",
    desc: "Agora você pode monitorar preços dos concorrentes em tempo real. Disponível no plano Premium.",
  },
  {
    date: "01 Abr",
    title: "Curso atualizado: Marketplace do Zero",
    desc: "Adicionamos 3 novas aulas sobre algoritmos de busca do Mercado Livre.",
  },
  {
    date: "25 Mar",
    title: "Comunidade no Discord aberta!",
    desc: "O servidor exclusivo para membros Pro e Premium já está no ar. Acesse em Comunidade.",
  },
];
...
export default function DashboardPage() {
  ...
  const isGratis = mockUser.plan === "Grátis";
        ...
        <section>
          <div className="flex items-center justify-between mb-4">
            ...
            <Link
              ...
              className="text-orbit-400 text-sm hover:text-orbit-200 transition-colors flex items-center gap-1"
            >
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {continueCourses.map((course) => (
              <Card key={course.slug} variant="dark" padding="none" hover className="overflow-hidden">
                {/* Thumbnail */}
                <div
                  className={`h-32 bg-gradient-to-br ${course.gradient} flex items-center justify-center relative`}
                >
            ...
            {recentTools.map((tool) => {
              ...
              return (
                <Link key={tool.slug} href={`/dashboard/ferramentas/${tool.slug}`}>
                  ...
                  >
                    <div
                      className={`w-10 h-10 rounded-xl flex items-center justify-center shrink-0 ${tool.bg}`}
                    >
